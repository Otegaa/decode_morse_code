...
**[Decode_morse_code]** is a program built to decode morse codes.
...
```sh
  git https://github.com/Otegaa/decode_morse_code.git
...
This project is [MIT](https://github.com/Otegaa/decode_morse_code/blob/dev/LICENSE) licensed.
